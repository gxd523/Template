...
public class ModuleProcessor extends AbstractProcessor {
    public static final String GENERATE_PACKAGE = "com.demo.generate.moduleapplication";
    private Filer filer;
    ...
    private void generateClass(Set<String> bridgeImplClassNameSet) throws IOException {
        ...
        TypeSpec classTypeSpec = TypeSpec.classBuilder(String.format("%sXXXX", moduleName))
